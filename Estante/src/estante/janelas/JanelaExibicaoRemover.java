 ...
 * @author Flavia
 */
public class JanelaExibicaoRemover extends javax.swing.JFrame {
     ...
     */
    public JanelaExibicaoRemover(JanelaPrincipal janelaPrincipal,int[] indexNovo,int aux) {
        initComponents();
    ...
    private void jButtonRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveActionPerformed
        ...
        {
            this.janelaPrincipal.estante.getRevitas().remove(count);
            this.janelaPrincipal.estante.setTotalDeRevistas(this.janelaPrincipal.estante.getTotalDeRevistas()-1);
        }}
